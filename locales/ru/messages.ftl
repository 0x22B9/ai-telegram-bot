...
start-welcome = Привет, { $user_name }! Я бот с ИИ на базе Gemini. Отправь мне текст или изображение (с подписью или без), и я постараюсь ответить. Используйте /help для просмотра команд.
...
error-gemini-request = Произошла ошибка при обращении к Gemini: { $error }
error-image-analysis-request = Произошла ошибка при анализе изображения: { $error }