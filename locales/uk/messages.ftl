...
Привіт, { $user_name }! Я бот на основі ШІ. Надішли мені текст або зображення (з підписом або без), і я постараюся відповісти. Використовуй /help для перегляду команд.
