...
start-welcome = Сәлем, { $user_name }! Мен Gemini негізіндегі AI ботпын. Маған мәтін немесе сурет жіберіңіз (жазбасымен немесе онсыз), мен жауап беруге тырысамын. Командаларды көру үшін /help пайдаланыңыз.
...
help-text =
    ...
    **Командалар:**
    /start - Ботты қайта іске қосып, тілді таңдаңыз
...
error-gemini-request = Gemini-мен байланысу кезінде қате пайда болды: { $error }
error-image-analysis-request = Суретті талдау кезінде қате пайда болды: { $error }